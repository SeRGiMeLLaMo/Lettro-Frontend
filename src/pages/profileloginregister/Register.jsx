    ...
    <div style={{ 
      ...
      <div 
        style={{ 
          ...
          maxWidth: "450px", 
          margin: "0 auto", 
          padding: "2.5rem 2rem", // Margen interno del formulario (padding)
        ...
        <div style={{ position: "relative", zIndex: 10 }}>
          ...
          <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: "1.5rem" }}>
            ...
            <div style={{ position: "relative" }}>
              <div style={iconStyle}>
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#7b6f67" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M19 21v-2a4 4 0 0 0-4-4H9a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/></svg>
              </div>
              <input
                name="name"
                type="text"
            ...
            <div style={{ position: "relative" }}>
              <div style={iconStyle}>
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#7b6f67" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="4"/><path d="M16 8v5a3 3 0 0 0 6 0v-1a10 10 0 1 0-4.5 8.5"/></svg>
              </div>
              <input
                name="username"
                type="text"
          ...
          <div style={{ margin: "1.5rem 0", display: "flex", alignItems: "center", gap: "1rem" }}>
            ...
            <span style={{ fontSize: "0.8rem", color: "#7b6f67", fontWeight: "600" }}>O ÚNETE CON</span>
            <div style={{ flex: 1, height: "1px", backgroundColor: "#e0d1c3" }}></div>
          </div>
          ...
          <div style={{ marginTop: "2rem", textAlign: "center" }}>
            <p style={{ fontSize: "0.875rem", color: "#7b6f67" }}>
              ...
              <Link to="/login" style={{ fontWeight: "600", color: "#8b5a2b", textDecoration: "none" }} onMouseOver={(e) => e.target.style.textDecoration = "underline"} onMouseOut={(e) => e.target.style.textDecoration = "none"}>
                Inicia sesión aquí
              </Link>
            </p>
          </div>
